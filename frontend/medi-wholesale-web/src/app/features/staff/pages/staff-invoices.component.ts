...
import { InvoiceDetailsDialogComponent } from '../dialogs/invoice-details-dialog.component';

@Component({
  selector: 'app-staff-invoices',
  standalone: true,
  imports: [
    MatTableModule,
    MatButtonModule,
...
export class StaffInvoicesComponent implements OnInit {
  private readonly api = inject(ApiService);
  private readonly dialog = inject(MatDialog);

  readonly invoices = signal<Invoice[]>([]);
  readonly cols = ['invoice', 'customer', 'date', 'amount', 'paymentStatus', 'actions'];
